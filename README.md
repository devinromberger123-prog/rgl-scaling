...
- **2026k.** Romberger, D. (2026). *A Bivariate Scaling Law for Noise Response Near Critical Transitions: Cross-Domain Validation from Mathematical Maps to Human Cardiac Dynamics (R² = 1.000, 0.987, 0.928).* DOI pending
